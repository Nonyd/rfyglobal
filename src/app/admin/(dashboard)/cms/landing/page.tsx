...
const FIELDS: CMSField[] = [
  ...
  {
    key: 'landing.hero.bg_position',
    label: 'Background Focus (Desktop)',
    type: 'text',
    placeholder: 'center',
    hint: 'CSS object-position for desktop, e.g. center, right center, 50% 20%. Default: center.',
  },
  {
    key: 'landing.hero.bg_position_mobile',
    label: 'Background Focus (Mobile)',
    type: 'text',
    placeholder: '70% center',
    hint: 'CSS object-position below 1024px width. Use to keep a subject in frame, e.g. 75% center, right top, 50% 30%. Default: 70% center.',
  },

...
const FIELDS: CMSField[] = [
  ...
  { key: 'contact.instagram', label: 'Instagram URL', type: 'url', hint: 'Full URL e.g. https://instagram.com/rfyglobal' },
  { key: 'contact.youtube', label: 'YouTube URL', type: 'url', hint: 'Full URL e.g. https://youtube.com/@yadah' },
  { key: 'contact.twitter', label: 'X (Twitter) URL', type: 'url', hint: 'Full URL e.g. https://x.com/rfyglobal' },
]

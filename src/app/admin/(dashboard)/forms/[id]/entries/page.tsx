  ...
  return (
    <div>
      ...
      <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between mb-8">
        <div>
          <h2 className="font-display text-2xl" style={{ color: 'var(--a-text)' }}>{form.title}</h2>
        ...
        <a
          ...
          className="inline-flex justify-center px-5 py-2.5 border text-sm font-body transition-colors w-fit"

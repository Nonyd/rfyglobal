  ...
  try {
    ...
    if (eventCount === 0) {
      await db.event.createMany({
        data: [
          { slug: 'abuja-monthly-gathering-abuja', title: 'Room For You — Abuja Monthly Gathering', description: 'Our monthly community gathering in Abuja.', city: 'Abuja', venue: 'The Civic Centre, Maitama', date: new Date(Date.now() + 14 * 86400000), time: '4:00 PM', isActive: true, imageUrl: 'https://images.unsplash.com/photo-1511795409834-ef04bbd61622?w=800&h=400&fit=crop' },
          { slug: 'lagos-monthly-gathering-lagos', title: 'Room For You — Lagos Monthly Gathering', description: 'The Lagos community comes together for worship, the Word, and fellowship.', city: 'Lagos', venue: 'The Landmark Event Centre, Victoria Island', date: new Date(Date.now() + 21 * 86400000), time: '5:00 PM', isActive: true, imageUrl: 'https://images.unsplash.com/photo-1540575467063-178a50c2df87?w=800&h=400&fit=crop' },
          { slug: 'port-harcourt-gathering-port-harcourt', title: 'Room For You — Port Harcourt Gathering', description: 'Port Harcourt, there is room for you too.', city: 'Port Harcourt', venue: 'Hotel Presidential, GRA', date: new Date(Date.now() + 28 * 86400000), time: '4:30 PM', isActive: true },
          { slug: 'online-prayer-night-online', title: 'Online Prayer Night', description: 'Join us online for a corporate prayer night.', city: 'Online', venue: 'Zoom — link sent to registered members', date: new Date(Date.now() + 7 * 86400000), time: '9:00 PM', isActive: true },
          { slug: 'abuja-outreach-abuja', title: 'Abuja Outreach', description: 'Foot evangelism in the streets of Abuja.', city: 'Abuja', venue: 'Wuse Market Area', date: new Date(Date.now() + 42 * 86400000), time: '10:00 AM', isActive: true },
          { slug: 'lagos-bible-study-marathon-lagos', title: 'Lagos Bible Study Marathon', description: 'A full-day Bible study event in Lagos.', city: 'Lagos', venue: 'Eko Hotel & Suites, Victoria Island', date: new Date(Date.now() + 56 * 86400000), time: '10:00 AM', isActive: true },
        ],
      })

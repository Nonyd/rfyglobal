...
/** Minimum gift amount + optional keys in same Credential row as global USD toggle. */
export const getMinimumGiftSettings = cache(() => fetchCredential<PaymentSettings>('paymentSettings'))
